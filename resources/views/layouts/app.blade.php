...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('dist/lte/dist/css/AdminLTE.min.css') }}">
    <link rel="stylesheet" href="{{ asset('dist/lte/dist/css/skins/_all-skins.min.css') }}">
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('dist/iCheck/skins/square/_all.css') }}">
...
@else
    ...
    <!-- AdminLTE App -->
    <script src="{{ asset('dist/lte/dist/js/adminlte.min.js') }}"></script>
